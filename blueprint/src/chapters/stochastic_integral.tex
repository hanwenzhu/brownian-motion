...
\inputleannode{lem:IsLocalMartingale.isLocalSubmartingale_sq_norm}




\inputleannode{def:quadraticVariation}
...
\begin{lemma}\label{lem:sq_norm_elemStochIntegral}
  \uses{def:elemStochIntegral, def:squareIntegrableMartingales, def:quadraticVariation, def:L2M}
